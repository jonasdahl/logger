...
export type DashboardOverviewQuery = { readonly __typename?: 'Query', readonly goals: ReadonlyArray<{ readonly __typename: 'GoalDayOfRest', readonly id: string, readonly title: string, readonly currentProgress: number, readonly currentDaysOfRest: number } | { readonly __typename: 'GoalDayOfWork', readonly id: string, readonly title: string, readonly currentProgress: number, readonly currentDaysOfWork: number } | { readonly __typename: 'GoalGeneric', readonly id: string, readonly title: string, readonly currentProgress: number | null } | { readonly __typename: 'GoalPerformExerciseType', readonly id: string, readonly title: string, readonly currentProgress: number, readonly currentDayCount: number }> };
...
export type GoalDetailsQuery = { readonly __typename?: 'Query', readonly timeZone: string, readonly goal: { readonly __typename: 'GoalDayOfRest', readonly id: string, readonly title: string, readonly currentProgress: number, readonly currentPeriodStart: string, readonly currentPeriodEnd: string, readonly currentDaysOfRest: number } | { readonly __typename: 'GoalDayOfWork', readonly id: string, readonly title: string, readonly currentProgress: number, readonly currentPeriodStart: string, readonly currentPeriodEnd: string, readonly currentDaysOfWork: number } | { readonly __typename: 'GoalGeneric', readonly id: string, readonly title: string, readonly currentProgress: number | null, readonly currentPeriodStart: string, readonly currentPeriodEnd: string } | { readonly __typename: 'GoalPerformExerciseType', readonly id: string, readonly title: string, readonly currentProgress: number, readonly currentPeriodStart: string, readonly currentPeriodEnd: string } | null };
